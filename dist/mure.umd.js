(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('uki'), require('xml-js'), require('scalpel'), require('d3'), require('pouchdb'), require('pouchdb-authentication')) :
	typeof define === 'function' && define.amd ? define(['uki', 'xml-js', 'scalpel', 'd3', 'pouchdb', 'pouchdb-authentication'], factory) :
	(global.mure = factory(global.uki,global.xmlJs,global.scalpel,global.d3,global.PouchDB,global.PouchDBAuthentication));
}(this, (function (uki,xmlJs,scalpel,d3,PouchDB,PouchDBAuthentication) { 'use strict';
