  ...
  *edgeClasses() {
  ...
  interpretAsEdges({
    ...
    if (!autoconnect || edgeClassIds.length > 2 || roles.indexOf('both') !== -1) {
      ...
      options.targetClassId = myTargetRole === 'source' ? targetEdgeClass.targetClassId : targetEdgeClass.sourceClassId; // Connect this class to the node classes on the other end of source /
